...
<body>
    ...
    <!-- <h4 style="margin-left:30px;text-decoration:underline;text-shadow: 0px 0px 10px rgba(0,0,0,0.3);";>02. Facebook data and load data  - </h4> -->
								...
								<div class="card-body">
									<div class="post-header clearfix">
										...
										<div class="post-user-info">
											...
											<p><?php echo $team['time'] ?><i class="fas fa-globe-americas"></i></p>
										</div>
										<a class="float-right" href="#"><i class="fas fa-ellipsis-h"></i></a>
									</div>
									<div class="post-content mt-2">
										<p><?php echo $team['des'] ?></p>
										<img src="<?php echo $team['image'] ?>" alt="">
									</div>
									<hr>
									<div class="post-likes clearfix">
										<div class="like float-left">
											<img src="assets/media/img/post/like.svg" alt=""> <?php echo $team['like'] ?>
										</div>
										<div class="comment float-right">
                                        <?php echo $team['comment'] ?>
										</div>
									</div>
									<hr>
